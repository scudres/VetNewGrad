            ...
            {programs.map((program, index) => (
              <div key={index} className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow duration-300">
                ...
                <p className="text-gray-700 mb-4">
                  <strong className="text-blue-600">Organization:</strong> {program.organization}
                </p>
...
const InternshipsResidencies = () => {
  const programs = [
    ...
    },
    {
      ...
      organization: "European College of Veterinary Surgeons",
      description: "Advanced surgical training programs leading to board certification in veterinary surgery.",
      url: "https://www.ecvs.org/education/residency-training/",
      country: "Europe"
    },
    {
      title: "ECVP Residency Programme",
      organization: "European College of Veterinary Pathologists",
      description: "Specialized training in veterinary pathology leading to board certification.",
      url: "https://www.ecvp.org/education/residency-programme/",
      country: "Europe"
    },
    {
      title: "University of Edinburgh Residency Programs",
      organization: "University of Edinburgh",
      description: "Various residency programs in collaboration with European colleges.",
      url: "https://www.ed.ac.uk/vet/postgraduate/residency-programmes",
      country: "UK"
    },
    {
      title: "RVC Residency Training",
      organization: "Royal Veterinary College",
      description: "Residency programs in multiple specialties at the UK's leading veterinary institution.",
      url: "https://www.rvc.ac.uk/study/postgraduate/residency-training",
      country: "UK"
    },
    {
      title: "University of Liverpool Residency Programs",
      organization: "University of Liverpool",
      description: "Specialized residency training programs in various veterinary disciplines.",
      url: "https://www.liverpool.ac.uk/vets/postgraduate/residency-programmes/",
      country: "UK"
    }
  ];
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {programs.map((program, index) => (
              <div key={index} className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow duration-300">
                ...
                <p className="text-gray-700 mb-4">
                  <strong className="text-green-600">Organization:</strong> {program.organization}
                </p>
                <p className="text-gray-600 mb-6 leading-relaxed">{program.description}</p>
                <a
                  href={program.url}
  ...
  const programs = [
    {
      ...
      organization: "Improve International",
    ...
    },
    {
      ...
      organization: "British Small Animal Veterinary Association",
    ...
    {
      title: "RVC Certificate in Advanced Veterinary Practice (CertAVP)",
      organization: "Royal Veterinary College",
      ...
      <header className="bg-white shadow-lg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            <Link 
              to="/"
              className="bg-purple-600 hover:bg-purple-700 text-white px-6 py-2 rounded-lg transition-colors duration-200 flex items-center"
            >
              <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 19l-7-7m0 0l7-7m-7 7h18" />
              </svg>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-purple-50 rounded-xl p-8 mb-12 border border-purple-200">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center bg-purple-600 hover:bg-purple-700 text-white px-6 py-3 rounded-lg font-medium transition-colors duration-200"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {programs.map((program, index) => (
              <div key={index} className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow duration-300">
                ...
                <p className="text-gray-700 mb-4">
                  <strong className="text-purple-600">Organization:</strong> {program.organization}
                </p>
                <p className="text-gray-600 mb-6 leading-relaxed">{program.description}</p>
                <a
                  href={program.url}
...
const VeterinaryCareerHub = () => {
  ...
  const categoryDetails = {
    training: {
      title: "Post-graduate Training Programs",
      description: "Comprehensive training programs designed for new veterinary graduates to develop clinical skills and experience in a structured environment.",
      programs: [
        {
          title: "CVS Veterinary Group Graduate Programme",
          organization: "CVS Group",
    ...
    internships: {
      title: "Internships & Residencies",
      description: "Specialized training opportunities for advanced veterinary education and board certification preparation.",
      programs: [
        {
          title: "VIRMP - Veterinary Internship and Residency Matching Program",
          organization: "USA/Canada",
    ...
    certificates: {
      title: "Postgraduate Certificates",
      description: "Advanced certification programs for practicing veterinarians to develop specialized expertise.",
      programs: [
        {
          title: "Improve International Postgraduate Programmes",
          organization: "Improve International",
      ...
      additionalInfo: {
        title: "About RCVS Certificate in Advanced Veterinary Practice (CertAVP)",
        description: "The CertAVP is an RCVS-accredited qualification that allows veterinarians to demonstrate advanced knowledge and skills in a chosen subject area.",
        url: "https://www.rcvs.org.uk/lifelong-learning/postgraduate-qualifications/certificate-in-advanced-veterinary-practice-certavp/",
        organization: "Royal College of Veterinary Surgeons"
      }
    }
  };
          ...
          {activeTab === "overview" && (
            <div className="space-y-16">
              ...
              {selectedCategoryDetail && (
                <section className="bg-gradient-to-br from-blue-50 to-white rounded-2xl p-8 shadow-lg">
                  <div className="flex items-center justify-between mb-8">
                    <h2 className="text-3xl font-bold text-gray-900">
                      {categoryDetails[selectedCategoryDetail].title}
                    </h2>
                    <button
                      onClick={() => setSelectedCategoryDetail(null)}
                      className="bg-gray-200 hover:bg-gray-300 text-gray-700 px-4 py-2 rounded-lg transition-colors duration-200 flex items-center"
                    >
                      <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <p className="text-lg text-gray-700 mb-8">
                    {categoryDetails[selectedCategoryDetail].description}
                  </p>
                  
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {categoryDetails[selectedCategoryDetail].programs.map((program, index) => (
                  ...
                  {/* Additional Info for Certificates */}
                  {selectedCategoryDetail === 'certificates' && categoryDetails[selectedCategoryDetail].additionalInfo && (
                    <div className="mt-8 bg-blue-50 rounded-xl p-6 border border-blue-200">
                      <h3 className="text-2xl font-bold text-blue-900 mb-4">
                        {categoryDetails[selectedCategoryDetail].additionalInfo.title}
                      </h3>
                      <p className="text-blue-800 mb-4">
                        {categoryDetails[selectedCategoryDetail].additionalInfo.description}
                      </p>
                      <p className="text-blue-700 mb-4">
                        <strong>Source:</strong> {categoryDetails[selectedCategoryDetail].additionalInfo.organization}
                      </p>
                      <a
                        href={categoryDetails[selectedCategoryDetail].additionalInfo.url}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center text-blue-600 hover:text-blue-800 font-medium"
                      >
                    ...
                    <div>
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="bg-purple-50 p-4 rounded-lg border border-purple-200">
                          <h5 className="font-semibold text-purple-900 mb-2">Provincial Nominee Program</h5>
                          <ul className="text-sm text-gray-700 space-y-1">
